...
wgcnaL <- WGCNA_sampleClusterDetectOutlier(wgcnaL, traitColors=wgcnaL$traitColors, removeOutlier = T)
```
...
```{r}
WGCNA_GeneModuleTraitCoorelation(wgcnaL$datExpr, MEs_col, geneTraitCor, traitData=wgcnaL$traitData, net, prefix=output_prefix, corType=corType)
```
