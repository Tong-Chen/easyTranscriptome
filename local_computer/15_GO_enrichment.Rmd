...
write.table(all_entrez[all_entrez[,1] != "",,drop=F], file="15_enrichment/ehbio.DESeq2.all.DE.entrez.txt", quote=F, sep="\t", row.names=F, col.names=F)

all_symbol <- combine_de[,c(3,2)]
write.table(all_symbol[all_symbol[,1] !="", ,drop=F], file="15_enrichment/ehbio.DESeq2.all.DE.symbol.txt", quote=F, sep="\t", row.names=F, col.names=F)
```
...
write.table(all_entrez, file="15_enrichment/ehbio_salmon.DESeq2.log2fc_ranked.entrez.txt", quote=F, sep="\t", row.names=F, col.names=F)

all_symbol <- combine_de[,c(3,2)]
all_symbol <- all_symbol[all_symbol[,1] !="", ,drop=F]
write.table(all_symbol, file="15_enrichment/ehbio_salmon.DESeq2.log2fc_ranked.symbol.txt", quote=F, sep="\t", row.names=F, col.names=F)
```
