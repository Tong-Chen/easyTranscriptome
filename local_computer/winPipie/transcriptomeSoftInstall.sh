...
## 安装我们自己写的脚本 (每种方法都必须要安装的)

	wget https://github.com/Tong-Chen/easyTranscriptome/archive/refs/tags/0.01.zip
	unzip 0.01.zip
	cp easyTranscriptome*/* ~/transcriptome/soft/
